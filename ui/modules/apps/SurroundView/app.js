...
.directive('surroundView', [function () {
  return {
    ...
    link: function (scope, element) {
      ...
      setStatus('starting', 'STARTING 4 CAMERA SURROUND VIEW…')
      ...
      var startLua = [
        ...
        "local okStart,startErr=xpcall(function() return ext.startSurroundView() end,debug.traceback)",
      ...
      scope.$on('$destroy', function () {
        try {
          bngApi.engineLua("if extensions.surroundView and extensions.surroundView.stopSurroundView then pcall(extensions.surroundView.stopSurroundView) end")
        } catch (err) {
